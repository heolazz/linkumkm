...
const ModulTematikDetail: React.FC<ModulTematikDetailProps> = ({ module, onBack, onRead }) => {
            ...
            <div className="flex flex-col lg:flex-row gap-8 mb-10">
                ...
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-1 mb-4">
                        {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} className={`w-5 h-5 ${star <= Math.round(module.rating || 4.6) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="mb-4">
                        <span className="inline-block text-[11px] text-[#3080E3] font-bold bg-[#e3f2fd] px-3 py-1.5 rounded-md uppercase tracking-widest">
                            {module.category}
                        </span>
                    </div>
                    ...
                    <div>
                        <button
                            onClick={onRead}
                            className="bg-[#3080E3] hover:bg-[#e66a00] text-white font-bold py-2.5 px-10 rounded-lg shadow-sm transition-colors text-[14px] active:scale-95"
                        >
                            Baca
                        </button>
                    </div>
