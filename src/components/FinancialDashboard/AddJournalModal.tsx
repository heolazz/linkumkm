            ...
            <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-full animate-in zoom-in duration-300">
                        ...
                        <div className="border border-[#E9EFF5] rounded-3xl overflow-hidden shadow-sm bg-white">
                            <table className="w-full">
                                <thead className="bg-gray-50/50 border-b border-[#E9EFF5]">
                                    <tr>
                                        <th className="px-5 py-4 text-[9px] font-bold text-text-muted uppercase tracking-widest text-left">Nama Akun</th>
                                        <th className="px-5 py-4 text-[9px] font-bold text-text-muted uppercase tracking-widest text-right w-[140px]">Debit (Rp)</th>
                                        <th className="px-5 py-4 text-[9px] font-bold text-text-muted uppercase tracking-widest text-right w-[140px]">Kredit (Rp)</th>
                                ...
                                <tfoot className="bg-gray-50/20 border-t border-[#E9EFF5]">
                                    ...
                                    <tr className="border-t border-[#E9EFF5]">
                                        <td className="px-5 py-4 font-bold text-black text-xs uppercase">Total</td>
                                        <td className="px-5 py-4 font-bold text-black text-right text-xs">Rp {totalDebit.toLocaleString('id-ID')}</td>
                ...
                <div className="p-8 bg-white border-t border-gray-100 sticky bottom-0">
                    <button
                        ...
                        disabled={!isBalanced}
                        className={`w-full py-5 rounded-2xl font-bold text-base transition-all shadow-xl active:scale-[0.98] ${isBalanced
